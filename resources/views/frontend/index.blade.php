...
<div class="main-card">
    <div class="card-item item-center">
        <a href="@auth {{ url('set-appointment/' . Auth::id()) }} @else {{ route('login') }} @endauth" style="text-decoration: none; color: inherit;">
            <div class="card-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="#007bff" stroke-width="2">
            ...
            <div style="text-align: start;" class="card-title text-primary">Book Appointment</div>
        </a>
    </div>
    ...
    <div class="card-item">
        <a href="@auth {{ url('medical/' . Auth::id()) }} @else {{ route('login') }} @endauth" style="text-decoration: none; color: inherit;">
            ...
            <div style="text-align: start;" class="card-title text-primary">My Medical File</div>
        </a>
    </div>
</div>
    ...
    <div class="services-grid">
        ...
        <a href="{{ url('about') }}" style="text-decoration: none; color: inherit;">
            <div class="service-item">
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke="#007bff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="48" height="48" aria-label="Hospital icon" role="img">
                ...
                <div class="service-name text-primary">About Obeid Hospital</div>
            </div>
        </a>
        ...
        <a href="@auth {{ url('lab-result/' . Auth::id()) }} @else {{ route('login') }} @endauth" style="text-decoration: none; color: inherit;">
            <div class="service-item">
                <div class="service-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="#007bff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="48" height="48" aria-label="Lab result icon" role="img">
                ...
                <div class="service-name text-primary">Investigation Result</div>
            </div>
        </a>
        ...
        <a href="@auth {{ url('my-appointment/' . Auth::id()) }} @else {{ route('login') }} @endauth" style="text-decoration: none; color: inherit;">
            <div class="service-item">
                ...
                <div class="service-name text-primary">My Appointment</div>
            </div>
        </a>
        ...
        <a href="{{ url('all-department') }}" style="text-decoration: none; color: inherit;">
            <div class="service-item">
                ...
                <div class="service-name text-primary">Our Department</div>
            </div>
        </a>
